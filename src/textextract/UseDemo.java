...
public class UseDemo {
	...
	public static void main(String[] args) throws IOException {
		...
		String content = getHTML("http://news.qq.com/a/20151028/047189.htm", "gb2312");
	...
	public static String getHTML(String strURL, String charserName) throws IOException {
		URL url = new URL(strURL);
		BufferedReader br = new BufferedReader(new InputStreamReader(url.openStream(), charserName));
		String s = "";
